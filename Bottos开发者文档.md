...
- [4. 本地运行](#4-本地运行)
    ...
    - [4.2. 准备Bottos可执行版本](#42-准备bottos可执行版本)
    - [4.3. 准备运行环境](#43-准备运行环境)
        - [4.3.1. 启动本地单节点环境](#431-启动本地单节点环境)
        - [4.3.2. 加入已存在的测试网络](#432-加入已存在的测试网络)
    - [4.4. 体验基本操作](#43-体验基本操作)
        - [4.4.1. 创建钱包](#441-创建钱包)
        - [4.4.2. 创建account](#442-创建account)
        - [4.4.3. 质押](#443-质押)
        - [4.4.4. 赎回](#444-赎回)
        - [4.4.5. 投票](#445-投票)
        - [4.4.6. 空间资源](#446-空间资源)
...
质押用户需要赎回质押的BTO，需要先操作解质押操作（4.4.5节，在手机端采取‘解质押’操作）。
...
\# ./bcli account stake --account bottostest --amount 100 --target space #空间资源，见章节 4.4.6

\# ./bcli account stake --account bottostest --amount 100 --target time #时间资源，见章节 4.4.7
